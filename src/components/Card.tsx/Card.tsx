...
const Card = ({ user, openChat, onClick }: CardProps) => {
  return (
    <div className="flex flex-col rounded-md max-w-64 gap-2 px-16 py-12 pt-9 bg-white justify-center relative items-center font-Inter drop-shadow-md">
